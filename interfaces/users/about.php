...
<nav class="navbar p-3 sticky-top">
    <div class="container-fluid">
        ...
        <!-- Note: This might display 'Hello, ' if session isn't started in this file, but this is the original code -->
        <a class="navbar-brand ms-auto text-white" href="#">Hello, User</a>
    </div>
</nav>
